    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save" action="{{ route('add') }}" method="POST" role="form text-left">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.role_id') border border-danger rounded-3 @enderror">
                                    <select wire:model="user.role_id" class="form-select" id="user-role">
                                ...
                                @error('user.role_id') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
