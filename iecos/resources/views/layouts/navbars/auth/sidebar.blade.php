...
<li class="nav-item">
    <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Jobs Settings</h6>
    <li>
    <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tables' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Reciclaje Usuario</span>
                </a>
            </li>
    </li>
    <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Reciclaje venta</span>
                </a>
            </li>
    </li>
            <li class="nav-item mt-2">
