...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/mainPictures/Logo-Test.png" class="navbar-brand-img h-100" alt="...">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        ...
        <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'store' ? 'active' : '' }}"
                    href="{{ route('store') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
    <a class="nav-link {{ (Route::currentRouteName() == 'solicitud' or Route::currentRouteName() == 'solicitud') ? 'active' : '' }}" href="{{ route('solicitud') }}">
            ...
            <li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'canjeos recompensas' ? 'active' : '' }}"
                    href="{{ route('canjeos recompensas') }}">
                    <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">canjeos</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'reciclable' ? 'active' : '' }}"
                    href="{{ route('reciclable') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Reciclaje</span>
                </a>
            </li>
    <li class="nav-item">
    <li class="nav-item">
